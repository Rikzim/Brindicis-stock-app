...
import { a as attr_class, c as clsx, b as attr, e as ensure_array_like, h as hasContext, g as getContext, s as setContext, d as attr_style, f as spread_props, i as escape_html, j as derived, k as stringify, l as attributes } from "../../chunks/root.js";
import "../../chunks/state.svelte.js";
import { r as run } from "../../chunks/effects.js";
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { children } = $$props;
    Toaster($$renderer2, { richColors: true });
    $$renderer2.push(`<!----> `);
    children?.($$renderer2);
    $$renderer2.push(`<!----> <div class="landscape-lock hidden fixed inset-0 z-[9999] bg-white dark:bg-slate-900 flex-col items-center justify-center gap-4 p-8 text-center"><svg class="size-16 text-amber-500 animate-bounce" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2" transform="rotate(0 12 12)"></rect><path d="M12 18v.01"></path></svg> <h2 class="text-xl font-bold text-slate-800 dark:text-slate-100">Modo Retrato</h2> <p class="text-sm text-slate-500 dark:text-slate-400 max-w-xs">Por favor, rode o dispositivo para o modo retrato para uma melhor experiência.</p></div>`);
  });
}
export {
  _layout as default
