...
<div class="flex h-screen items-center justify-center bg-[#F3F4F6] dark:bg-slate-950">
  <div class="text-center">
    ...
    <a
      href="/stock"
      onclick={(e) => { e.preventDefault(); navigateTo("/stock"); }}
      class="mt-6 inline-block rounded-lg bg-[#FBBF24] px-6 py-3 text-sm font-semibold text-[#1F2937] hover:bg-amber-500 transition-colors"
    >
      Voltar ao Início
    </a>
  </div>
